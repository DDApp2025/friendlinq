...
var getData = function (criteria, projection, options) {
    return new Promise((resolve, reject) => {
        PostLikeModel.find(criteria, projection, options).then(data=>{  //console.log("data",data,criteria);
             return resolve(data);
        }).catch(err => {
             return reject(err);
        });
...
var InsertData = function (objToSave) {  //console.log("objToSave==",objToSave);
    return new Promise((resolve, reject) => {
        new PostLikeModel(objToSave).save().then(data => {
            return resolve(data);
        }).catch(err => { 
...
var updateData = function (criteria, dataToSet, options) {
    return new Promise((resolve, reject) => {
        PostLikeModel.findOneAndUpdate(criteria, dataToSet, options).then(data => {
            return resolve(data);
        }).catch(err => {
...
var deleteData = function (criteria) {    
    return new Promise((resolve, reject) => {
        PostLikeModel.findOneAndRemove(criteria).then(data=>{  //console.log("data",data,criteria);
             return resolve(data);
        }).catch(err => {
             return reject(err);
        });
